...
/datum/station_trait/cybernetic_revolution
	...
	var/static/list/job_to_cybernetic = list(
		...
		// ORBSTATION JOBS
		/datum/job/assistant/dept/eng = /obj/item/organ/cyberimp/mouth/breathing_tube,
		/datum/job/assistant/dept/med = /obj/item/organ/cyberimp/eyes/hud/medical,
		/datum/job/assistant/dept/sci = /obj/item/organ/cyberimp/chest/reviver, //perfect for test subjects
		/datum/job/assistant/dept/srv = /obj/item/organ/cyberimp/chest/nutriment,
	)
