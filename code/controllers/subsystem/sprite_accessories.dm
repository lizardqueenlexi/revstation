...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	feature_list[FEATURE_RAT_SNOUT] = INIT_ACCESSORY(/datum/sprite_accessory/rat_snouts)
	feature_list[FEATURE_RAT_TAIL] = INIT_ACCESSORY(/datum/sprite_accessory/tails/rat)
	feature_list[FEATURE_RAT_EARS] = INIT_ACCESSORY(/datum/sprite_accessory/rat_ears)
