...
/datum/surgery_operation/organ/lobotomy/on_preop(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_notice("You begin to perform an experimental neural bypass on [FORMAT_ORGAN_OWNER(organ)]'s brain..."), //ORBSTATION EDIT: self message
		span_notice("[surgeon] begins to perform an experimental neural bypass on [FORMAT_ORGAN_OWNER(organ)]'s brain."), //ORBSTATION EDIT: detailed message
...
/datum/surgery_operation/organ/lobotomy/on_success(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_notice("You successfully reorganised the mind of [FORMAT_ORGAN_OWNER(organ)]!"), //ORBSTATION EDIT: self message
		span_notice("[surgeon] successfully reorganised the mind of [FORMAT_ORGAN_OWNER(organ)]!"), //ORBSTATION EDIT: detailed message
...
/datum/surgery_operation/organ/lobotomy/on_failure(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_warning("You alter the wrong part, causing more damage!"), //ORBSTATION EDIT: self message
		span_notice("[surgeon] unsuccessfully attempts to reorganize the mind of [FORMAT_ORGAN_OWNER(organ)]!"), //ORBSTATION EDIT: detailed message
