...
/datum/surgery_operation/organ/pacify/on_preop(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_notice("You begin to carefully insert the chip into [FORMAT_ORGAN_OWNER(organ)]..."), //ORBSTATION EDIT: its a chip
...
/datum/surgery_operation/organ/pacify/on_success(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_notice("You place the pacification chip in [FORMAT_ORGAN_OWNER(organ)]."),  //ORBSTATION EDIT: adds Artificially
...
/datum/surgery_operation/organ/pacify/on_failure(obj/item/organ/brain/organ, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		organ.owner,
		span_notice("You screw up, scratching [FORMAT_ORGAN_OWNER(organ)]'s brain with the chip..."), //ORBSTATION EDIT: chip mention
