...
/datum/preference/choiced/language/is_accessible(datum/preferences/preferences)
	...
	return FALSE //return /datum/quirk/bilingual::name in preferences.all_quirks //not compatible with ORBSTATION language system
...
/datum/preference/choiced/language_skill/is_accessible(datum/preferences/preferences)
	...
	return FALSE // /datum/quirk/bilingual::name in preferences.all_quirks //not compatible with ORBSTATION language system
