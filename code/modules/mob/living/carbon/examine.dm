...
/mob/living/carbon/examine(mob/user)
	...
	/*else if(nutrition >= NUTRITION_LEVEL_FAT) ORBSTATION REMOVAL
	...
	ADD_NEWLINE_IF_NECESSARY(.)
	. += examine_xcards() //ORBSTATION ADDITION
	. += span_notice("<i>Examine again to take a better look...</i>") //ORBSTATION ADDITION
